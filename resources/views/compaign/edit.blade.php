...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit Campaign: <b>{{$compaign->name_compaign}}</b></div>
    ...
    <div class="panel-body">
        {!! Form::model($compaign, ['route' => ['compaign.update', $compaign->id_compaign], 'method' => 'PUT']) !!}

        @include('compaign._form')
