...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit Subscriber: <b>{{$subscriber->email_subscriber}}</b></div>
    ...
    <div class="panel-body">
        {!! Form::model($subscriber, ['route' => ['subscriber.update', $subscriber->id_subscriber], 'method' => 'PUT']) !!}
